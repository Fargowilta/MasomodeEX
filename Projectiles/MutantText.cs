...
namespace MasomodeEX.Projectiles
{
    public class MutantText : ModProjectile
    {
        ...
        public string[] spam = {
            ...
            "MY INFINITE POWER, THE POTENTIAL OF ETERNITIES STRETCHED TO THE ABSOLUTE MAXIMUM APOTHEOSES!",
            ...
            "I BRING FORTH CALAMITIES, CATASTROPHES, AND CATACLYSM; ELDRITCH POWERS DERIVED FROM THE ABSOLUTE WORD OF FATE.",
            ...
            "A CONJURER IS BUT A PEDDLING MAGICIAN, A TRAWLER A SLIVER COMPARED TO MY LIFE MASTERY!",
            ...
            "THAT’S WHY YOU LIMP ON THIS MOIST ROCK SEARCHING FOR STICKS AND PEBBLES TO ELIMINATE THE FEARS YOU CANNOT TRULY OVERCOME!",
            "IT REALLY SURPRISES ME THAT IT TOOK YOU AWHILE TO REACH THIS POINT, GIVEN HOW GOOD YOU ARE AT LEECHING ON YOUR OPPONENTS AFTER BARELY SCRAPING BY!",
            "THAT’S HOW YOU WIN ALL YOUR BATTLES, AM I RIGHT!?",
            "IT’S HONESTLY IMPRESSIVE THAT YOU’VE MADE IT THIS FAR. I HOPE YOU WEREN’T USING GODMODE, PATHETIC COWARD!",
